...
import { deleteMember, mapDeleteMemberError, updateCustomer, mapUpdateCustomerError, updateCustomerSchema } from "@/lib/memberships";
...
// ── POST: Cập nhật thông tin khách hàng/hội viên ─────────
export async function POST(
  ...
  try {
    ...
    return resultToResponse(result, mapUpdateCustomerError);
  } catch (error) {
...
// ── DELETE: Xoá mềm hội viên (admin/manager) ─────────────────
